      ...
      const mockAuditTrail: AuditTrailEntry[] = [
        {
          ...
          exceptionId: "1020129_131907931_SICOVAM",
          revType: "DELETE",
          actions: ["Exception marked for deletion", "Workflow completed"],
          equityClassType: "Fund (Ex)",
          regulator: "PRA",
          aging: 3,
          asOfTime: "2025-09-11 10:15:22",
          ...
          processed_exceptions: "2025-09-11 10:15:22",
          sdsBookCode: 1020129,
        ...
        },
        {
          ...
          exceptionId: "1020129_131907931_SICOVAM",
          revType: "UPDATE",
          actions: ["Status updated to In Progress", "Assigned to workflow team", "Position quantity adjusted"],
          equityClassType: "Fund (Ex)",
          regulator: "PRA",
          aging: 2,
          asOfTime: "2025-09-10 14:30:15",
          bbUnderlyings: "Sophis/131907931/006878.TWO",
          esmSecurityType: "ETF",
          instrumentId: 131907931,
          instrumentName: "00687B.TWO",
          ...
          legalEntity: "BCSL",
          lookThrough: "Y",
          positionAv: 1050000.50,
          positionQty: 1650000,
          positionBbbClassification: "BankingBook",
          processed_exceptions: "2025-09-10 14:54:01",
          sdsBookCode: 1020129,
          sdsBookPath: "Barclays Group:Markets:Equities:Prime:Prime Delta 1:APAC:Delta One Synthetics:Index/Sector/CIB:Delta 1 - Non Index PLIS-Taiwan:Conversion - BCSL(15170)",
          sodDeltaOnBbUnderlying: 1050000.50,
          status: "IN PROGRESS",
          system: "Atlas",
          originalQty: 1680000,
        },
        {
          ...
          exceptionId: "1020129_131907931_SICOVAM",
          revType: "INSERT",
          actions: ["New Exception created", "Initial data populated from source system"],
          equityClassType: "Fund (Ex)",
          regulator: "PRA",
          aging: 1,
